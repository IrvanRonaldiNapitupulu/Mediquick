...
import 'package:mediquick/screens/apotek_role/add_product_screen.dart';
import 'package:mediquick/screens/apotek_role/edit_product_screen.dart';
...
class _ProductListScreenState extends State<ProductListScreen> {
  ...
  Future<void> _loadProducts() async {
    ...
    if (apotekId == null) {
      AppLogger.debug("apotek_id tidak ditemukan di SharedPreferences");
      return;
    }

    final response = await http.get(
      Uri.parse(
        '${ApiConstants.productsReadByApotek}?apotek_id=$apotekId',
      ),
    );
    ...
    if (response.statusCode == 200) {
      ...
      AppLogger.debug('Gagal load produk: ${response.statusCode}');
    }
  }
  ...
  Future<void> _deleteProduct(int id) async {
    ...
    final response = await http.post(
      Uri.parse(ApiConstants.productsDelete),
      body: {
        'id': id.toString(),
