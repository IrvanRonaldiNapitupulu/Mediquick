...
import 'dart:convert';
import 'package:mediquick/screens/admin/add_pharmacy_screen.dart';
  ...
  Future<void> _fetchUsers() async {
    try {
      final response = await http.get(
        Uri.parse("${ApiConstants.getUser}?role=Apotek"),
      );
  ...
  Future<void> _deleteUser(String userId) async {
    try {
      final response = await http.post(
        Uri.parse(ApiConstants.adminDeleteApotek),
      ...
      AppLogger.debug("Error decoding JSON: $e");
      ScaffoldMessenger.of(context).showSnackBar(
