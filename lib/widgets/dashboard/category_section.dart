...
import 'package:mediquick/screens/edukasi/article_detail_screen.dart';
import 'package:mediquick/widgets/edukasi/lihat_semua_kesehatan.dart';
import 'package:mediquick/widgets/edukasi/lihat_semua_pertolongan.dart';
...
class _CategorySectionState extends State<CategorySection> {
  ...
  Future<void> fetchArticles() async {
    try {
      ...
      AppLogger.debug('Error fetching articles: $e');
      if (!mounted) return;
  ...
  Future<List<Article>> fetchByType(String type) async {
    final url = Uri.parse('${ApiConstants.articles}?type=$type');
